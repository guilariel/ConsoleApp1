...
{
    public class PurchaseStocksCrudPossession
    {
        private readonly PurchaseStocksDbContext _context;
        private readonly PurchaseStocksCrudUsers _crudUsers;

        public PurchaseStocksCrudPossession(PurchaseStocksDbContext context, PurchaseStocksCrudUsers crudUsers)
        {
            _context = context;
